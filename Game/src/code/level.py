...
class Level:
    ...
    def create_map(self) -> None:
        ...
        CyanSpider((2100, 950), [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        RedSpider((1700, 400),  [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        RedGreenSpider((1750, 400),  [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        CyanRedSpider((1780, 400),  [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        BlueSnowSpider((1900, 400),  [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        Goblin((1180, 1670), [self.visible_sprites, self.attackable_sprites], self.obstacles_sprites, self.damage_player, self)
        
        self.player = Player((2500, 1500), [self.visible_sprites], self.attackable_sprites, self.obstacles_sprites, self.create_attack, self.destroy_weapon, '../graphics/player/up_idle/up_idle_0.png')
